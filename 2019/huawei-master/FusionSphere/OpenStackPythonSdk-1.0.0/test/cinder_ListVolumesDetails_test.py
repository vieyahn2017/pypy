...
if __name__ == '__main__':
    ...
    search_opts={'name':'testzzh_20160408'}
#    offset=8656865

    volumes = cinder_client.volumes.list(detailed=True, search_opts=None, marker=None, limit=5,
             sort_key=None, sort_dir=None, metadata=None, offset=None, changes_since=None, availability_zone=None)
