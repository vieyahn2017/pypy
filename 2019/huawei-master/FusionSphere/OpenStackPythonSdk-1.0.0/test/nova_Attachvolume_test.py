...
if __name__ == '__main__':
    ...
    volumeAttachment=nova_client.volumes.create_server_volume(server_id="64540b99-246a-4664-965a-ab1df616d2c8",volume_id="58e8aade-3a51-443a-92a6-902ee8750b6b", device="/dev/sdf")
    prn_obj(volumeAttachment)
